...
export default function MaterialIssuePage() {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: async (created) => {
            try {
                ...
                toast({
                    title: 'Posted',
                    description: `Material issue submitted (GL ${glCount}, SLE ${sleCount}).`,
                });
            } catch {
                // Non-blocking
            }
            toast({
                title: 'Success',
                description: 'Material issue created and submitted successfully.',
            });
    ...
    const onSubmit = (data: StockEntryFormValues) => {
        const payload = {
            stock_entry_type: 'Material Issue' as const,
        ...
        <div className="space-y-6 max-w-7xl mx-auto">
                ...
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Issue stock from warehouse</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter details for issuing materials from your warehouse
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Warehouse to issue materials from
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}

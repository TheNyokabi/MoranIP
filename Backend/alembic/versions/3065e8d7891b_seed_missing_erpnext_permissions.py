"""seed_missing_erpnext_permissions

Revision ID: 3065e8d7891b
Revises: 65d1a23cba57
Create Date: 2026-01-06 12:07:07.657581
...
revision: str = '3065e8d7891b'
down_revision: Union[str, None] = '65d1a23cba57'
...
def upgrade() -> None:
    ...
    # Fixed: Using bind parameter for exclude_code to avoid SQLAlchemy binding issues with colon
    conn.execute(text("""
        INSERT INTO role_permissions (id, role_id, permission_id)
        SELECT 
            gen_random_uuid(),

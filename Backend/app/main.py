...
from .routers import pos_profiles, pos_sessions, pos_orders, pos_quick_actions, pos_payments, pos_receipts, pos_loyalty, pos_layaway, pos_sync, pos_analytics  # PoS routers

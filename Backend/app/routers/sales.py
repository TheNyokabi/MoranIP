...
def check_permission(payload: dict, action: str, doctype: str):
    ...
    require_permission(payload, f"sales:{doctype.lower().replace(' ', '_')}:{action}")
...
def list_quotations(
    ...
    """List Quotations."""
    check_permission(payload, "view", "Quotation")
...
def create_quotation(
    ...
    """Create Quotation."""
    check_permission(payload, "create", "Quotation")
...
def update_quotation(
    ...
    check_permission(payload, "edit", "Quotation")
...
def list_sales_orders(
    ...
    """List Sales Orders."""
    check_permission(payload, "view", "Sales Order")
...
def create_sales_order(
    ...
    """Create Sales Order."""
    check_permission(payload, "create", "Sales Order")
...
def update_sales_order(
    ...
    check_permission(payload, "edit", "Sales Order")
...
def list_delivery_notes(
    ...
    """List Delivery Notes."""
    check_permission(payload, "view", "Delivery Note")
...
def create_delivery_note(
    ...
    check_permission(payload, "create", "Delivery Note")
...
def update_delivery_note(
    ...
    check_permission(payload, "edit", "Delivery Note")
...
def update_sales_invoice(
    ...
    check_permission(payload, "edit", "Sales Invoice")
